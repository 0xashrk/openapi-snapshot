...
| 6 | 6.1 | Output profiles | add `outline` profile | Planned |
| 6 | 6.2 | Outline shape | path + schema refs only | Planned |
| 6 | 6.3 | Docs + tests | README + tests reflect outline | Planned |
